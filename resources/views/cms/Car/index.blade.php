                                ...
                                <tbody>
                                    @foreach ($cars as $car)
                                        <tr>
                                            ...
                                            <td>{{ $car->model }}</td>
                                            <td>{{ $car->sour_car }}</td>
                                            <td>{{ $car->merchants->name }}</td>
                                            <td>{{ $car->created_at }}</td>
                                            <td>{{ $car->updated_at }}</td>
                                            <td> 
                                                <div class="btn-group">
                                                    @can('Update-Car')
                                                    <a href="{{ route('car.edit', $car->id) }}" type="button"
                                                        class="btn btn-info">
                                                    ...
                                                    <a href="#" class="btn btn-danger"
                                                        onclick="confirmDestroy({{ $car->id }},this)">
