                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="icheck-success d-inline">
                                                    <input type="checkbox"
                                                        onclick="store({{ $merchantId }}, {{ $permission->id }})"
                                                        id="permission_{{ $permission->id }}" @if ($permission->is_active) checked @endif>
...
@section('scripts')
    ...
    <script>
        function store(merchantId, permissionId) {
            axios.post('/cms/admin/merchants/' + merchantId + '/permissions ', {
